...
def getWeather():
    try:
        city=text_field.get()
        geolocator=Nominatim(user_agent="geoapExercises")
        ...
        api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=b76b2a7d48ddaed7bdd346e2425788ed"
    ...
    t=Label(font=("arial",50,"bold"),fg="#eee666d")
    t.place(x=400,y=150)
